...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            #region Beneficiario
            if (cliente.Beneficiario.Count > 0)
            {
                foreach (var beneficiario in cliente.Beneficiario)
                {
                    List<System.Data.SqlClient.SqlParameter> parametrosBeneficiarios = new List<System.Data.SqlClient.SqlParameter>();
                    parametrosBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("Cpf", beneficiario.Cpf));
                    parametrosBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("Nome", beneficiario.Nome));
                    parametrosBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("IdCliente", ret));

                    DataSet ds2 = base.Consultar("FI_SP_IncBeneficiario", parametrosBeneficiarios);
                }
            }
            #endregion
